      ...
      <div className="max-w-md w-full  p-6 transition duration-500">
        <div className="flex items-center space-x-4 p-4">
          ...
          <div className="flex flex-col space-y-2">
            <h1 className="text-xl font-bold text-black mr-4">
              {user.username}
            </h1>
            <p className="mt-4 mr-4 text-gray-600 text-sm text-justify">
              {user.bio}
            </p>
          </div>
        </div>
        ...
        <div className="mt-6 flex justify-between items-center">
          ...
          <button
            className="text-white px-4 py-2 rounded-lg hover:bg-red-600 shadow-md transition duration-300 btn-logout"
