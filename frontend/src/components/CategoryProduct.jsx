...
const CategoryProducts = () => {
    ...
    const fetchProducts = async () => {
      try {
        ...
        if (
          ...
          fetchedProducts[0].category.length > 0
        ) {
          setCategoryName(fetchedProducts[0].category[0].title);
        } else {
          setCategoryName("نامشخص");
        }
      } catch (error) {
  ...
  return (
    <div className="products-container">
      <h2 className="products-title">محصولات {categoryName}</h2>
