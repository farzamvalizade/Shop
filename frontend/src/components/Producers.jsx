...
const Producers = () => {
    ...
    const fetchProducers = async () => {
      try {
        const response = await axios.get(
          "https://zonal-compassion-production.up.railway.app/api/producers/",
        );
  ...
  return (
    <div className="p-6 products-container">
      <h2 className="text-3xl font-bold text-center mb-12 text-blue-600 products-title">
        لیست سازندگان
      </h2>
