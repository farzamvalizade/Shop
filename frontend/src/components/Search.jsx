    ...
    const fetchProducts = async () => {
      try {
        const response = await axios.get(
          `https://zonal-compassion-production.up.railway.app/api/products/?search=${encodeURIComponent(query)}`,
        );
    ...
    <div className="products-container">
      ...
      <div className="products-grid">
        {products.length > 0 ? (
          ...
          <p className="w-1/2 text-center text-xl bg-red-300 text-red-800 p-4 rounded-md shadow ">
            محصولی یافت نشد.
          </p>
        )}
      </div>
